...
--
-- Host: localhost
-- Generation Time: May 23, 2011 at 04:58 PM
...
(1226, 'Production and operations department managers in transport, storgae and communications'),
...
(1316, 'General managers in transport, storage and communication'),
...
(3139, 'Optical and electronic equipement operators not elsewhere classified'),
...
(3419, 'Finance and sales associate professionals not elsewhere classifed'),
...
(3474, 'Clowns, magicians, acrobates and related associate professionals'),
...
(511, 'Travel attendents and related workers'),
...
(6152, 'Inland and coatsal waters fishery workers'),
...
(7122, 'Bricklayersand stonemasons'),
...
(724, 'Electrical and electronic equipement mechanics and fitters'),
...
(751, 'Metal worker n.e.c.'),
(7510, 'Metal worker n.e.c.'),
(752, 'Electronics engineers n.e.c.'),
...
(8163, 'Icinerator, water-treatment and relted plant operators'),
...
(8224, 'Photographic-products machine operators operators'),
...
(8274, 'Baked-goods, cereal and chocolate-prodcuts machine operators'),
...
(9152, 'Doorkeepers, watchpersons uggage porters and deliverers'),
